...
class CardGiftCard(db.Model):
    ...
    gfSerial = db.Column(db.String(64, collation='utf8_unicode_ci'), unique=True, index=True, nullable=False)
    ...
    gfStatus = db.Column(db.Integer, nullable=False, index=True)
